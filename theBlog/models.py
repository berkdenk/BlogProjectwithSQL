...
class Post(models.Model):
    ...
    author=models.ForeignKey(User,on_delete=models.CASCADE) #silinen kullanıcının postunun silinmesi için
...
class Comment(models.Model):
    post = models.ForeignKey(Post,related_name="comments" ,on_delete=models.CASCADE) #silinen kullanıcının postunun silinmesi için
    name = models.CharField(max_length=255)
    body = models.TextField()
